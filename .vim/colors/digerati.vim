...
hi Function     guifg=#FFC66D gui=bold
hi Type 		guifg=#53abc7 gui=none
hi Statement 	guifg=#ff3b77 gui=bold
hi Keyword		guifg=#ff3b77 gui=none
hi Constant 	guifg=#ff3b77 gui=none
hi Number		guifg=#a5c261 gui=none
hi Special		guifg=#ff3b77 gui=none
hi PreProc 		guifg=#b8b89f gui=none
hi PreProc      guifg=#e6e1dc gui=none
